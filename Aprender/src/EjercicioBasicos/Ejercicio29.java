...
public class Ejercicio29 {
	...
	public static void main(String[] args) {
		...
		long producto=1; // producto guardará la multiplicación de los 10 primeros números impares.
		 // es muy importante acordarse de inicializarlo a 1. Ya que si lo hacemos a 0, siempre valdra 0 
		...
		for (int i=1; i<20; i+=2) {
			 ...
			 System.out.print("La multiplicación de los 10 primeros impares: " + producto);
